...
public class LeftTeethPanel extends JPanel {
	
	private static final long serialVersionUID = 1L;
	GridBagConstraints gc = new GridBagConstraints();
	JTextField tfEleven = null;
	JTextField tfTwelve = null;
...
//		gc.weighty = 20.0;
	...
	public static void main(String[] LeftTeethSet)
	{
		...
		frame.getContentPane().add(new LeftTeethPanel());
